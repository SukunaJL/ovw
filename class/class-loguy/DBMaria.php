...
global $dbLink;
$dbLink = new mysqli("127.0.0.1",$DB_USER, $DB_PASSWORD, "loguy");
...
class DB {
	...
	static public function connect($dbName) {
		...
		$DB_USER = 'devt';
		$DB_PASSWORD = trim(file_get_contents("/home/.devt"));
		$dbLink = new mysqli("127.0.0.1",$DB_USER, $DB_PASSWORD, $dbName);
		mysqli_query($dbLink, "SET NAMES UTF8");
	}
	/**
	...
	static function escape($value) {
		global $dbLink;
		return $dbLink->real_escape_string($value);
	}
	 ...
	 *	$params->page int Numéo de la page à acciher
